            ...
            <div class="PLP-product-list">
                ...
                <div class="product">
                    ...
                    <div class="row product-warp">
                            ...
                            <div class="col-4 pl-0 productItem-left">
                                <div style={{display: 'flex', flexDirection: 'row'}}>
                                    <div class="imgDiv"><img
                                            src="https://i.ibb.co/72cfBN9/Chocolate-Brownie-removebg-preview.png" alt=""
                                            class="img-fluid"/></div>
                                </div>
                            </div>
                                ...
                                <div class="col-12 pr-0 product-desc">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 prod-desc">
                                            <p> Min. Order Quantity: <span>4 unit(s)</span> </p>
                        ...
                        <div class="variant-priceboxes">
                            <div>
                                <div class="pricebox">
                                    <div class="pricebox__text">
                                        <p>500 gm</p><strong><span class="display-price"
                                                style={{fontFamily: 'OS-bold'}}>₹317.20</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="pricebox">
                                    <div class="pricebox__text">
                                        <p>18 Kg</p><strong><span class="display-price"
                                                style={{fontFamily: 'OS-bold'}}>₹301.34</span></strong>
                                        <div class="priceValue-div"><span><span></span></span>
                                            <p> (4 % off)</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="pricebox">
                                    <div class="pricebox__text">
                                        <p>36 Kg</p><strong><span class="display-price"
                                                style={{fontFamily: 'OS-bold'}}>₹36.00</span></strong>
                                        <div class="priceValue-div"><span><span></span></span>
                                            <p> (7 % off)</p>
                                        </div>
                                    </div>
                        ...
                        <div class="counter-price-div">
                            ...
                            <div class="price-taxline-wrapper">
                                <div class="counter-price-div__displayPrice" style={{marginBottom: '0px'}}><span>₹ 317.2/KG
                                    </span><span class="strikethrough-price">₹175</span></div>
                        ...
                        <div class="sample-req-line"><span><strong>*</strong>Sample order will be delivered in next route of
                                delivery</span></div>
                    </div>
                </div>
                </a>
                    ...
                    <div class="row product-warp">
                        <div style={{display: 'flex', justifyContent: 'space-between'}}>
                            <div class="col-4 pl-0 productItem-left">
                                <div style={{display: 'flex', flexDirection: 'row'}}>
                                    <div class="imgDiv"><img
                                            src="https://i.ibb.co/VMyLcrg/Walnut-Brownie-2-removebg-preview.png" alt=""
                                            class="img-fluid"/></div>
                                </div>
                            </div>
                            <div class="vegTag"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                        ...
                        <div class="variant-priceboxes">
                            <div>
                                <div class="pricebox">
                                    <div class="pricebox__text">
                                        <p>50 gm</p><strong><span class="display-price"
                                                style={{fontFamily: 'OS-bold'}}>₹359.10</span></strong>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="pricebox">
                                    <div class="pricebox__text">
                                        <p>36 Pcs</p><strong><span class="display-price"
                                                style={{fontFamily: 'OS-bold'}}>₹179.60</span></strong>
                                        <div class="priceValue-div"><span><span></span></span>
                                            <p> (2 % off)</p>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <div class="pricebox">
                                    <div class="pricebox__text">
                                        <p>72 Pcs</p><strong><span class="display-price"
                                                style={{fontFamily: 'OS-bold'}}>₹167.90</span></strong>
                                        <div class="priceValue-div"><span><span></span></span>
                                            <p> (4 % off)</p>
                                        </div>
                                    </div>
                        ...
                        <div class="counter-price-div">
                            ...
                            <div class="price-taxline-wrapper">
                                <div class="counter-price-div__displayPrice" style={{marginBottom: '0px'}}><span>₹ 359.1/KG
                                    </span><span class="strikethrough-price">₹199</span></div>
                                <div class="taxes-line" style={{padding: '0px'}}>
                                    <p> (Prices are exclusive of taxes*)</p>
                                </div>
                            </div>

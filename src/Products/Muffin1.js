...
export default function Muffin1() {
  return (
    <>
                ...
                <div class="row product-warp">
                        ...
                        <div class="col-4 pl-0 productItem-left">
                            <div style={{display: 'flex', flexDirection: 'row'}}>
                                <div class="imgDiv"><img
                                        src="https://i.ibb.co/dGTZYyN/Blueberry-Muffin-2-removebg-preview.png" alt=""
                                        class="img-fluid"/></div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 pr-0 product-desc">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 prod-desc">
                                        <p> Min. Order Quantity: <span>6 unit(s)</span> </p>
                    ...
                    <div class="variant-priceboxes">
                            ...
                            <div class="pricebox">
                                <div class="pricebox__text">
                                    <p>50 gm</p><strong><span class="display-price"
                                            style={{fontFamily: 'OS-bold'}}>₹28.60</span></strong>
                                </div>
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            <div class="pricebox">
                                <div class="pricebox__text">
                                    <p>144 Pcs</p><strong><span class="display-price"
                                            style={{fontFamily: 'OS-bold'}}>₹26.70</span></strong>
                                    <div class="priceValue-div"><span><span></span></span>
                                        <p> (12 % off)</p>
                                    </div>
                                </div>
                    ...
                    <div class="counter-price-div">
                        ...
                        <div class="price-taxline-wrapper">
                            <div class="counter-price-div__displayPrice" style={{marginBottom: '0px'}}><span>₹ 28.6/pc
                                </span><span class="strikethrough-price">₹31</span></div>
                ...
                <div class="row product-warp">
                    <div style={{display: 'flex', justifyContent: 'space-between'}}>
                        <div class="col-4 pl-0 productItem-left">
                            <div style={{display: 'flex', flexDirection: 'row'}}>
                                <div class="imgDiv"><img
                                        src="https://i.ibb.co/fpbssmV/Chocolate-Muffin-2-removebg-preview.png" alt=""
                                        class="img-fluid"/></div>
                            </div>
                        </div>
                        <div class="vegTag"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                    ...
                    <div class="counter-price-div">
                        ...
                        <div class="price-taxline-wrapper">
                            <div class="counter-price-div__displayPrice" style={{marginBottom: '0px'}}><span>₹ 28/pc
                                </span><span class="strikethrough-price">₹31</span></div>
                            <div class="taxes-line" style={{padding: '0px'}}>
                                <p> (Prices are exclusive of taxes*)</p>
                            </div>
                ...
                <div class="row product-warp">
                    <div style={{display: 'flex', justifyContent: 'space-between'}}>
                        <div class="col-4 pl-0 productItem-left">
                            <div style={{display: 'flex', flexDirection: 'row'}}>
                                <div class="imgDiv"><img
                                        src="https://i.ibb.co/wyMR7v5/Vanilla-Muffin-2-copy-removebg-preview.png" alt=""
                                        class="img-fluid"/></div>
                            </div>
                        </div>
                        <div class="vegTag"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                    ...
                    <div class="variant-priceboxes">
                        <div>
                            <div class="pricebox">
                                <div class="pricebox__text">
                                    <p>50 gm</p><strong><span class="display-price"
                                            style={{fontFamily: 'OS-bold'}}>₹25.30</span></strong>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="pricebox">
                                <div class="pricebox__text">
                                    <p>72 Pcs</p><strong><span class="display-price"
                                            style={{fontFamily: 'OS-bold'}}>₹24.30</span></strong>
                                    <div class="priceValue-div"><span><span></span></span>
                                        <p> (4 % off)</p>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div class="pricebox">
                                <div class="pricebox__text">
                                    <p>144 Pcs</p><strong><span class="display-price"
                                            style={{fontFamily: 'OS-bold'}}>₹23.60</span></strong>
                                    <div class="priceValue-div"><span><span></span></span>
                                        <p> (7 % off)</p>
                                    </div>
                                </div>
                    ...
                    <div class="counter-price-div">
                        ...
                        <div class="price-taxline-wrapper">
                            <div class="counter-price-div__displayPrice" style={{marginBottom: '0px'}}><span>₹ 25.3/pc
                                </span><span class="strikethrough-price">₹28</span></div>
                            <div class="taxes-line" style={{padding: '0px'}}>
                                <p> (Prices are exclusive of taxes*)</p>
                            </div>
                        </div>

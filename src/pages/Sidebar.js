...
export default function Sidebar() {
    ...
    // const showbackdrop = () => setbackdrop(!backdrop)
    ...
    <>
        <div className="nav-home">
            <div className="navbar-compo">
                <div className="hamburger"  onClick={toggleSidebar}><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
                ...
                <div className="logo-div"><img src={image1} className="img-fluid logo-img"/></div>
                <div className="nav-icons"><a href="/login">
                        <div className="nav-side cart-icon"> <svg stroke="currentColor" fill="none" stroke-width="0"
                                viewBox="0 0 24 24" height="25" width="25" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z">
                                </path>
                            </svg></div>
                    </a><a href="/search-products">
                        <div className="search-icon"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                        ...
                        <div className="pro-sidebar-layout">
                            ...
                            <div className="pro-sidebar-content sidebarContent">
                                <nav className="pro-menu Sidebar_menu__2X59C shaped square inner-submenu-arrows"
                                    ...
                                    <ul><a firstchild="1" popperarrow="0" href="/">
                                        ...
                                        </a><a firstchild="1" popperarrow="0" href="/login">
                                            <li className="pro-menu-item Sidebar_menuItem__37ym_">
                                                <div className="pro-inner-item" tabindex="0" role="button"><span
                                                        className="pro-icon-wrapper"><span className="pro-icon"><svg
                                                                stroke="currentColor" fill="currentColor" stroke-width="0"
                                ...
                                <nav className="pro-menu Sidebar_menu__2X59C shaped square inner-submenu-arrows">
                                    <ul>
                                        <div firstchild="1" popperarrow="0"
                                            style={{fontSize: '1.25rem', fontWeight: '600', margin: '0.75rem'}}><span> About User
                                            </span></div><a firstchild="1" popperarrow="0" href="/login">
                                            <li className="pro-menu-item Sidebar_menuItem__37ym_">
                                                <div className="pro-inner-item" tabindex="0" role="button"><span
                                                        className="pro-icon-wrapper"><span className="pro-icon"><svg
                                                                stroke="currentColor" fill="currentColor" stroke-width="0"
                                                                viewBox="0 0 512 512" className="Sidebar_icons__2Z2FR"
                                                                height="25" width="25" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                            ...
                                            <li className="pro-menu-item Sidebar_menuItem__37ym_">
                                                <div className="pro-inner-item" tabindex="0" role="button"><span
                                                        className="pro-icon-wrapper"><span className="pro-icon"><svg
                                                                stroke="currentColor" fill="currentColor" stroke-width="0"
                                                                viewBox="0 0 576 512" className="Sidebar_icons__2Z2FR"
                                                                height="25" width="25" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                            ...
                                            <li className="pro-menu-item Sidebar_menuItem__37ym_">
                                                <div className="pro-inner-item" tabindex="0" role="button"><span
                                                        className="pro-icon-wrapper"><span className="pro-icon"><svg
                                                                stroke="currentColor" fill="currentColor" stroke-width="0"
                                                                viewBox="0 0 320 512" className="Sidebar_icons__2Z2FR"
                                                                height="25" width="25" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                        ...
                                        </a><a firstchild="1" popperarrow="0" href="/refer-to-friend">
                                            <li className="pro-menu-item Sidebar_menuItem__37ym_">
                                                <div className="pro-inner-item" tabindex="0" role="button"><span
                                                        className="pro-icon-wrapper"><span className="pro-icon"><svg
                                                                stroke="currentColor" fill="currentColor" stroke-width="0"
                                                                viewBox="0 0 640 512" className="Sidebar_icons__2Z2FR"
                                                                height="25" width="25" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                ...
                                <nav className="pro-menu Sidebar_menu__2X59C shaped square inner-submenu-arrows">
                                    <ul>
                                        <div firstchild="1" popperarrow="0"
                                            style={{fontSize: '1.25rem', fontWeight: '600', margin: '0.75rem'}}><span> About
                                                Company </span></div><a firstchild="1" popperarrow="0" href="/login">
                                            <li className="pro-menu-item Sidebar_menuItem__37ym_">
                                                <div className="pro-inner-item" tabindex="0" role="button"><span
                                                        className="pro-icon-wrapper"><span className="pro-icon"><svg
                                                                stroke="currentColor" fill="currentColor" stroke-width="0"
                                                        ...
                                                        className="pro-item-content"><span>Feedback</span></span></div>
                                            </li>
                                        </a><a firstchild="1" popperarrow="0" href="/contact-us">
                                            <li className="pro-menu-item Sidebar_menuItem__37ym_">
                                                <div className="pro-inner-item" tabindex="0" role="button"><span
                                                        className="pro-icon-wrapper"><span className="pro-icon"><svg
                                                                stroke="currentColor" fill="currentColor" stroke-width="0"
                                        ...
                                        </a><a firstchild="1" popperarrow="0" href="/about-us">
                                            <li className="pro-menu-item Sidebar_menuItem__37ym_">
                                                <div className="pro-inner-item" tabindex="0" role="button"><span
                                                        className="pro-icon-wrapper"><span className="pro-icon"><svg
                                                                stroke="currentColor" fill="currentColor" stroke-width="0"
                            ...
                            <div className="pro-sidebar-footer Sidebar_footer__3pqwB"><a href="/login"><button>Login<svg
                                        ...
                                        </svg></button></a><a href="/register">
                                    <div style={{display: 'flex', justifyContent: 'center'}}><span
                                            className="Sidebar_signupLink__1D0V3">New here ? <span> Signup.</span></span></div>
                                </a>

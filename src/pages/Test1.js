    ...
    <div className="MuiContainer-root app__container MuiContainer-maxWidthLg">
        ...
        <div className="KYCForm_kycForm__2q2yD">
            ...
            <div className="NavKYC_navKyc__-M7M5">
                <div style={{display: 'flex', cursor: 'pointer'}}><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                    ...
                    <div className="NavKYC_logoutIcon__2knWC"><span>Logout</span><svg stroke="currentColor" fill="currentColor"
                            stroke-width="0" viewBox="0 0 24 24" color="#fff" height="25" width="25"
      ...
      <Accordion expanded style={{border: 'none', backgroundColor: 'rgb(241, 240, 238)'}}>
        ...
        >
          ...
          <p className="MuiTypography-root MuiTypography-body1 css-9l3uo3"><svg
                                            ...
                                            aria-hidden="true" viewBox="0 0 24 24" data-testid="AssignmentIndOutlinedIcon">
                                            <path
                                            ...
                                            <div className="MuiAccordionDetails-root css-u7qq7e">
                                                <p className="MuiTypography-root MuiTypography-body1 css-9l3uo3">
                                                    <div className="RegisterForm_personalDetails__tSGfZ">
                                                        <div className="RegisterForm_personalDetails__group1__w1b88">
                                                            <div style={{display: 'flex', justifyContent: 'space-between'}}>
                                                                <div className="form-group" style={{width: '48%'}}><label
                                                                        className="RegisterForm_input-name-label__2np7K">First
                                                                        name<span>*</span></label><input type="text"
                                                                        name="firstName" className="form-control " readonly=""
                                                                ...
                                                                <div className="form-group" style={{width: '48%'}}><label
                                                                        ...
                                                                        name<span>*</span></label><input type="text"
                                                                        name="lastName" className="form-control " readonly=""
                                                                        style={{width: '95%', borderRadius: '1rem'}}/>
                                                                    <div className="invalid-feedback">
                                                                        <p> </p>
                                                                    </div>
                                                            ...
                                                            <div className="form-group col-12"><label
                                                                    ...
                                                                    email address<span>*</span></label><input type="text"
                                                                    name="email" className="form-control " readonly=""/>
                                                                <div className="invalid-feedback">
                                                                    <p> </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="RegisterForm_personalDetails__group2__1EVWu">
                                                            <div className="form-group col-12"><label
                                                                    className="RegisterForm_input-name-label__2np7K">Secondary
                                                                    email address</label><input type="text" name="email2"
                                                            ...
                                                            <div>
                                                                <div className="form-group col-12"><label
                                                                        ...
                                                                        type="text" name="mobile" className="form-control "
                                                                        readonly=""/>
                                                                    <div className="invalid-feedback">
                                                                        <p> </p>
                                                                    </div>
                                                                </div>
                                                                <div className="form-group col-12 second-mobile-div"><label
                                                                        className="RegisterForm_input-name-label__2np7K">Secondary
                                                                        Mobile Number</label><input type="text"
                                                                        name="mobile2" className="form-control "/>
                                                                    <div className="invalid-feedback">
                                                                        <p> </p>
                                                                    </div>
                                                                </div>
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')} style={{border: 'none', backgroundColor: 'rgb(241, 240, 238)'}}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon />}
          ...
          <Typography sx={{ width: '33%', flexShrink: 0 }}>                 
                            <div className="MuiButtonBase-root MuiAccordionSummary-root MuiAccordionSummary-gutters css-1iji0d4"
                                ...
                                <div className="MuiAccordionSummary-content MuiAccordionSummary-contentGutters css-17o5nyn">
                                    <p className="MuiTypography-root MuiTypography-body1 css-9l3uo3"><svg
                                            className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv" focusable="false"
                                            aria-hidden="true" viewBox="0 0 24 24" data-testid="BusinessCenterOutlinedIcon">
                                            <path
                                ...
                                <div className="MuiCollapse-wrapper MuiCollapse-vertical css-hboir5">
                                    <div className="MuiCollapse-wrapperInner MuiCollapse-vertical css-8atqhb">
                                        <div aria-labelledby="panel2a-header" id="panel2a-content" role="region"
                                            ...
                                            <div className="MuiAccordionDetails-root css-u7qq7e">
                                                <p className="MuiTypography-root MuiTypography-body1 css-9l3uo3">
                                                    <div className="RegisterForm_company-details-input-group__L4_Ta">
                                                        <div className="form-group"><label
                                                                className="RegisterForm_input-name-label__2np7K">Business
                                                                name<span>*</span></label><input type="text"
                                                                name="companyName" className="form-control " readonly=""/>
                                                            <div className="invalid-feedback">
                                                                <p> </p>
                                                            </div>
                                                        </div>
                                                        <div className="form-group"><label
                                                                className="RegisterForm_input-name-label__2np7K">Business
                                                                type<span>*</span></label><select name="companyType"
                                                                className="form-select form-control " readonly="">
                                                                <option disabled=""> Select Business Type</option>
                                                                <option value="Affordable Casual Dine">Affordable Casual
                                                                    Dine</option>
                                                                <option value="Cafe">Cafe</option>
                                                                <option value="Caterers">Caterers</option>
                                                                <option value="Central Government Entity">Central Government
                                                                    Entity</option>
                                                                <option value="Cloud Kitchen">Cloud Kitchen</option>
                                                                <option value="Desserts &amp; Ice-Creams">Desserts &amp;
                                                                    Ice-Creams</option>
                                                                <option value="Educational Institute">Educational Institute
                                                                </option>
                                                                <option value="Fine Dine">Fine Dine</option>
                                                                <option value="Hotels">Hotels</option>
                                                                <option value="Institutional Suppliers">Institutional
                                                                    Suppliers</option>
                                                                <option value="Petroleum Business">Petroleum Business
                                                                </option>
                                                                <option value="Premium Casual Dine">Premium Casual Dine
                                                                </option>
                                                                <option value="Pubs &amp; Bars">Pubs &amp; Bars</option>
                                                                <option value="State Government Entity">State Government
                                                                    Entity</option>
      ...
      <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')} style={{border: 'none', backgroundColor: 'rgb(241, 240, 238)'}}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon />}
        ...
        >
          ...
          <div className="MuiButtonBase-root MuiAccordionSummary-root MuiAccordionSummary-gutters css-1iji0d4"
                                ...
                                <div className="MuiAccordionSummary-content MuiAccordionSummary-contentGutters css-17o5nyn">
                                    <p className="MuiTypography-root MuiTypography-body1 css-9l3uo3"><svg
                                            className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv" focusable="false"
                                            aria-hidden="true" viewBox="0 0 24 24" data-testid="ArticleOutlinedIcon">
                                            <path
                                                                    ...
                                                                    <div style={{marginRight: '1.5rem'}}><span
                                                                            ...
                                                                            aria-disabled="false"><span
                                                                                className="MuiIconButton-label"><input
                                                                                    className="jss4" name="docType" type="radio"
                                                                                    value="gstDoc" checked=""/><svg
                                                                                    stroke="currentColor"
                                                                                    fill="currentColor" stroke-width="0"
                                                                                    viewBox="0 0 512 512" color="#d2112c"
                                                                    ...
                                                                    <div><span
                                                                            ...
                                                                            aria-disabled="false"><span
                                                                                className="MuiIconButton-label"><input
                                                                                    ...
                                                                                    stroke="currentColor"
                                                                                    fill="currentColor" stroke-width="0"
                                                                                    viewBox="0 0 512 512" color="#707070"
                                                                                    height="1em" width="1em"
                                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                ...
                                                                <div className="RegisterForm_fileUpload__2-6U2"
                                                                    ...
                                                                    <div className="form-group">
                                                                        <div style={{display: 'flex'}}>
                                                                            <div className="RegisterForm_gstn-input__1114d">
                                                                        ...
                                                                        <div style={{display: 'flex'}}><label for="gstUpload"
                                                                                ...
                                                                                copy</label> <input id="gstUpload"
                                                                                type="file" name="gstUpload"
                                                                                className="form-control "
                                                                                style={{display: 'none'}}/><button>
                                                                                Upload</button></div>
                                                                        <div className="invalid-feedback"></div>
                                                                        <div><span className="RegisterForm_fileNameSpan__3kNLG">
                                                                                <svg stroke="currentColor"
                                                                                    fill="currentColor" stroke-width="0"
                                                                                    version="1.1" viewBox="0 0 16 16"
                                                                                    color="#0078ac" height="20" width="20"
                                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            <p>Please select the declaration if you don't
                                                                                have GST Registration</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div className="RegisterForm_multi_GST_declare__1rS1x"><span
                                                                        ...
                                                                        aria-disabled="false"><span
                                                                            className="MuiIconButton-label"><input className="jss4"
                                                                                name="multipleGST_check" type="checkbox"
                                                                                data-indeterminate="false"
                                                                                value="false"/><svg stroke="currentColor"
                                                                                fill="currentColor" stroke-width="0"
                                                                            ...
                                                                            have multiple GSTs</span></label></div>
                                                            </div>
                                                            <div className="RegisterForm_no_GST_declare__2MuoE"><span
                                                                    className="MuiButtonBase-root MuiIconButton-root jss1 MuiCheckbox-root MuiCheckbox-colorSecondary MuiIconButton-colorSecondary"
                                                                    aria-disabled="false"><span
                                                                        className="MuiIconButton-label"><input className="jss4"
                                                                            name="noGstCheck" type="checkbox"
                                                                            data-indeterminate="false" value="false"/><svg
                                                                            stroke="currentColor" fill="currentColor"
                                                                            stroke-width="0" viewBox="0 0 16 16"
                                                                            color="#707070" height="15" width="15"
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            style={{color: 'rgb(112, 112, 112)'}}>
                                                                            <path
                                                                                d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z">
                                                                        ...
                                                                        className="MuiTouchRipple-root"></span></span><label><span>I
                                                                        do hereby declare that I am not applicable for GST
                                                        ...
                                                        <div
                                                            ...
                                                            <div className="RegisterForm_fileUpload__2-6U2">
                                                                <div
                                                                    ...
                                                                    <div className="RegisterForm_pan-input__143vj"><input
                                                                    ...
                                                                    <div style={{display: 'flex'}}><label for="file-upload-pan"
                                                                            className="RegisterForm_customFileUploadLabel__1_FdB"><input
                                                                                id="file-upload-pan" type="file"
                                                                                name="panUpload" className="form-control "
                                                                            ...
                                                                            a PAN</label><button> Upload</button></div>
                                                                    <div><span className="RegisterForm_fileNameSpan__3kNLG">
                                                                            <svg stroke="currentColor" fill="currentColor"
                                                                                stroke-width="0" version="1.1"
                                                                                viewBox="0 0 16 16" color="#0078ac"
                                                                                height="20" width="20"
                                                                                xmlns="http://www.w3.org/2000/svg"
                                                                                style={{color: 'rgb(0, 120, 172)'}}>
                                                                                <path
      ...
      <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')} style={{border: 'none', backgroundColor: 'rgb(241, 240, 238)'}}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon />}
          aria-controls="panel4bh-content"
          id="panel4bh-header"
        >
          <Typography sx={{ width: '33%', flexShrink: 0 }}>                            <div className="MuiButtonBase-root MuiAccordionSummary-root MuiAccordionSummary-gutters css-1iji0d4"
                                tabindex="0" role="button" aria-expanded="false" aria-controls="panel2a-content"
                                id="panel2a-header">
                                <div className="MuiAccordionSummary-content MuiAccordionSummary-contentGutters css-17o5nyn">
                                    <p className="MuiTypography-root MuiTypography-body1 css-9l3uo3"><svg
                                                ...
                                                <p className="MuiTypography-root MuiTypography-body1 css-9l3uo3">
                                                    <div className="RegisterForm_bankDetailsContainer__1Tjf8">
                                                        <div className="RegisterForm_inputGroup-wrap__2wLi8">
                                                            <div
                                                                ...
                                                                <div className="form-group"><label
                                                                        ...
                                                                        Number</label><input type="text" name="accountNo"
                                                                        className="form-control "/>
                                                                    <div className="invalid-feedback">
                                                                        <p> </p>
                                                                    </div>
                                                            ...
                                                            <div>
                                                                <div className="form-group"><label
                                                                        ...
                                                                        Code</label><input type="text" name="ifsc"
                                                                        className="form-control "/>
                                                                    <div className="invalid-feedback">
                                                                        <p> </p>
                                                                    </div>
                                                                ...
                                                                <div className="form-group"><label
                                                                        ...
                                                                        name="branchName" className="form-control "/>
                                                                    <div className="invalid-feedback">
                                                                        <p> </p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div className="form-group"><label
                                                                ...
                                                                Cancelled cheque or Bank Letter confirming account
                                                                details</label>
                                                            <div className="RegisterForm_fileUpload__2-6U2">
                                                                <div
                                                                    style={{display: 'flex', flexDirection: 'column', marginBottom: '0.75rem'}}>
                                                                    <div style={{display: 'flex'}}><label
                                                                            ...
                                                                            className="RegisterForm_customFileUploadLabel__1_FdB"><input
                                                                                id="file-upload-bank" type="file"
                                                                                name="bankDocUpload" className="form-control "
                                                                                style={{display: 'none'}}/><svg
                                                                                stroke="currentColor" fill="currentColor"
                                                                                stroke-width="0" viewBox="0 0 24 24"
                                                                                height="20" width="20"
                                                                                ...
                                                                                here</span> </label><button> Upload</button>
                                                                    </div>
                                                                    <div><span className="RegisterForm_fileNameSpan__3kNLG">
                                                                            <svg stroke="currentColor" fill="currentColor"
                                                                                stroke-width="0" version="1.1"
                                                ...
                                                <p className="MuiTypography-root MuiTypography-body1 css-9l3uo3">
                                                    <div className="RegisterForm_declaration-wrap__dHgAB">
                                                        <div className="col-12 termsNConditions"><span
                                                                ...
                                                                aria-disabled="false"><span
                                                                    className="MuiIconButton-label"><input className="jss4"
                                                                        name="tncCheck" type="checkbox"
                                                                        data-indeterminate="false" value="false"/><svg
                                                                        stroke="currentColor" fill="currentColor"
                                                                        stroke-width="0" viewBox="0 0 16 16" color="#707070"
                                                                        height="18" width="18"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        style={{color: 'rgb(112, 112, 112)'}}>
                                                                        <path
                                                                ...
                                                                do hereby declare that the information provided by me is
